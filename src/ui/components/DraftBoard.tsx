            ...
            return (
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="rounded-full border border-emerald-400/30 bg-emerald-400/10 px-2.5 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-emerald-200">
                    {player.position}
                  </span>
