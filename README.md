...
3. **Draft** — the app runs a full snake draft; bots pick for the other 11 teams automatically, may proactively bring you trade offers during their turns, and will evaluate your counters before the bot chain resumes. The live draft room is split into **Board**, **Players**, **Feed**, and **Roster** tabs so you can inspect the draft board, available players, the room-wide pick feed, or a single team's pick log without leaving the room.
